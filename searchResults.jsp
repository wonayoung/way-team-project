       ...
       <section class="py-3">
		  ...
		  <div class="d-flex1">
					...
					<form name="searchPrd" method="post" action="searchResults.jsp">
						<input type="search" name="keyword" class="btn img_bar" placeholder="검색어를 입력하세요">
					</form> 
                 
                 </div>
			   </center>
           <div class="sub_title1" id="x">총 5개의 상품이 검색되었습니다.</div>
		 </section>
...
%>
<script>
	document.getElementById("x").textContent="총 <%=count%>개의 상품이 검색되었습니다.";
</script>
