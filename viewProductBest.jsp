...
%>
       ...
       <section class="py-3">
		  <p class="MD title">BEST</p>
           <div class="sub_title">홈 > 상품 > BEST</div>
		 </section>
<div class="container  px-4 px-lg-5">
    <div class="menu_01">
<div class="menu_target">BEST</div>
...
<br>
		 ...
		 <div class="container  px-4 px-lg-5">
 <div class="number"> 상품 9</div>
<div class="next1">&nbsp; &nbsp;높은 가격</div>
...
<div class="col mb-5">
                    <div class="card h-100" >
                            <!-- Product image-->
						<div class="card_best">1</div>
				      <div class="card-img-top" >
<img src="images/image/calcium_002_main.jpg"   /> </div>
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                  ...
                                  <span class="money_sell" style="color: #000099; font-weight: bolder;">7,500원</span></div>
                                    <!-- Product price-->
