...
<%
	...
	String jsql = "select * from product ORDER BY salePrice DESC";
...
<div class="next1">&nbsp; &nbsp;<a href="viewProductAll.jsp" style="
    color: #000099; font-weight: bold;">높은 가격</a></div>
			 
<div class="next1">|</div><div class="next">
 
  <a href="viewProductAll_low.jsp">낮은 가격</a>&nbsp; &nbsp;</div></div>
