   ...
   if ((x=MM_findObj(a[i]))!=null){document.MM_sr[j++]=x; if(!x.oSrc) x.oSrc=x.src; x.src=a[i+2];}
    ...
    <body onLoad="MM_preloadImages('images/next.png')" style="overflow-x:hidden; overflow-y:auto;">
      ...
      %>
       ...
       <section class="py-3">
		  <p class="MD title">광고문의</p>
           <div class="sub_title">홈 > 광고문의</div>
		 </section>
    ...
    <div class="container px-4 px-lg-5 mt-5">
      ...
      <article class="advertisement">
        <div class="adr_title">WAY 몰 광고문의 <br><br><br>
		  > 이메일 : ad@way.com <br><br>
		  > 문의전화 : 02-0000-0000 <br><br>
		  > 업무시간 : 평일 09:00~18:00 *주말 및 공휴일은 휴무입니다.</div><br>
		  <form><input type="button" value="문의하기" class="btn_advert" onclick="location.href='https://forms.gle/rYdAjYzhFSfCUVDx6' "></form>
      </article>
    </div>
