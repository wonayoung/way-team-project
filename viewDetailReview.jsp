...
<tr>      
    <td  height="200px" width="200px" align="center"><img src="prdImages\<%=prdNo%>_main.jpg" class="card-img-top" /></td>     
	<td  height="200"align="left" style="padding-left:30px;"><font size="2"><%=prdName%></font></td> 
       ...
       <form method="post" name="input">       
 	   ...
 	   <tr>
 	      ...
 	      <td><textarea rows="15" cols="100%" name="in_content" placeholder="상품 리뷰를 작성해 주세요." style="width: 100%;">
  	   ...
  	   <tr>
 	      ...
 	      <td> <input type="button" value="사진/동영상 첨부" OnClick="in_check()" class="btn_submitfile1"></td>
	       ...
	       <div class="star_count_04"> </div></label>
						      ...
						      <label>
						        <input type="radio" name="RadioGroup1" value="라디오" id="RadioGroup1_2">
						      <div class="star_count_03"> </div></label>
						     
						      <label>
						        <input type="radio" name="RadioGroup1" value="라디오" id="RadioGroup1_3">
						         <div class="star_count_02"> </div></label>
						      
						      <label>
						        <input type="radio" name="RadioGroup1" value="라디오" id="RadioGroup1_4">
 	      ...
 	      <td><div class="sex_select">
 	        <p>
 	          <label>
 	            <input type="radio" name="RadioGroup2" value="woman" id="RadioGroup2_0">
 	            여성</label>&nbsp; &nbsp; 
 	          
 	          <label>
 	            <input type="radio" name="RadioGroup2" value="boy" id="RadioGroup2_1">
 	            남성</label>&nbsp; &nbsp; 
 	          
 	          <label>
 	            <input type="radio" name="RadioGroup2" value="sex_none" id="RadioGroup2_2">
 	            선택안함</label>
...
<tr>
 	      ...
 	      <td><div class="sex_select">
 	        <p>
 	          <label>
 	            <input type="radio" name="RadioGroup3" id="RadioGroup2_0">
 	            10대</label>&nbsp; &nbsp; 
 	          
 	          <label>
 	            <input type="radio" name="RadioGroup3" id="RadioGroup2_1">
 	            20대</label>&nbsp; &nbsp; 
 	          
 	          <label>
 	            <input type="radio" name="RadioGroup3"  id="RadioGroup2_2">
 	            30대</label>&nbsp; &nbsp; 
 	            <label>
 	            <input type="radio" name="RadioGroup3" id="RadioGroup2_2">
 	            40대</label>&nbsp; &nbsp; 
