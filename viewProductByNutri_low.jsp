...
<%
	...
	String jsql = "select * from product WHERE chiefNutri = ? ORDER BY salePrice ASC";
...
<div class="next1">&nbsp; &nbsp;<a href="viewProductByNutri_high.jsp?nutri=<%=nutri%>">높은 가격</a></div>
			 
<div class="next1">|</div><div class="next">
 
  <a style="
    color: #000099; font-weight: bold;" href="viewProductByNutri.jsp?nutri=<%=nutri%>">낮은 가격</a>&nbsp; &nbsp;</div></div>
