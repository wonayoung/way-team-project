   ...
   if ((x=MM_findObj(a[i]))!=null){document.MM_sr[j++]=x; if(!x.oSrc) x.oSrc=x.src; x.src=a[i+2];}
    ...
    <body onLoad="MM_preloadImages('images/next.png')" style="overflow-x:hidden; overflow-y:auto;">
      ...
      %>
        ...
        <!-- Section-->
<%
	 String nutri = request.getParameter("nutri");
	...
	String jsql = "select * from product WHERE chiefNutri = ? ORDER BY salePrice DESC";
	PreparedStatement pstmt = con.prepareStatement(jsql);
	pstmt.setString(1,nutri);
	ResultSet rs = pstmt.executeQuery();
	
%>		 
       <section class="py-3">
		  <p class="MD title">성분별</p>
           <div class="sub_title">홈 > 상품 > 성분별</div>
		 </section>
<div class="container  px-4 px-lg-5">
    <div class="menu_01">
<div class="menu_target">성분별</div>
				
<br><br>
				<a href="viewProductByNutri.jsp?nutri=vitK">비타민K</a>
				<br><br>
				<a href="viewProductByNutri.jsp?nutri=vitC">비타민C</a>
				<br><br>
		<a href="viewProductByNutri.jsp?nutri=thistle">밀크씨슬</a>
		<br><br>
				
		<a href="viewProductByNutri.jsp?nutri=Q10">코엔자임 Q10</a>
				
				<br><br>
				<a href="viewProductByNutri.jsp?nutri=omega3">오메가3</a>
				
				<br><br>
		<a href="viewProductByNutri.jsp?nutri=multi">멀티비타민</a>
				
				<br><br>
		<a href="viewProductByNutri.jsp?nutri=lutein">루테인</a>
				
				<br><br>
		<a href="viewProductByNutri.jsp?nutri=lacto">유산균</a>
				
				<br><br>
		<a href="viewProductByNutri.jsp?nutri=hyalAcid">하일루론산</a>
				
				<br><br>
		<a href="viewProductByNutri.jsp?nutri=enzyme">효소</a>
				
				<br><br>
		<a href="viewProductByNutri.jsp?nutri=calcium">칼슘</a>
...
<div class="next1">&nbsp; &nbsp;<a style="
    color: #000099; font-weight: bold;" href="viewProductByNutri.jsp?nutri=<%=nutri%>">높은 가격</a></div>
			 
<div class="next1">|</div><div class="next">
 
  <a href="viewProductByNutri_low.jsp?nutri=<%=nutri%>">낮은 가격</a>&nbsp; &nbsp;</div></div>
