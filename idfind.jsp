...
<div class="container1 px-4 px-lg-5">
  ...
  <div class="service"><a href="login.jsp">로그인</a>&nbsp;&nbsp; <a href="signup.jsp"> 회원가입</a>&nbsp; &nbsp; 고객센터</div>
        ...
        <a href="#">전체상품</a>
				...
				<div class="footer_title01">아이디 찾기</div>
					<div class="container px-4 px-lg-5 mt-5">
					  					<div class="container px-4 px-lg-5 mt-5">
					<div class="signUp6"><br>				
					    <div class="inputtitle">이름*</div> <input name="name" type="text"  class="inputtext" placeholder="이름을 입력해주세요">
				
<div class="inputtitle">휴대폰 번호* </div>
<select  class="inputphone">
	<option>010</option>
    <option>015</option>
    <option>016</option>
    <option>017</option>
    <option>018</option>
</select><input type="text" name="phone1" class="inputphone">-<input type="text" name="phone2" class="inputphone1"><br> <br>
<br>
			
				<input type="button" value="확인" onClick="checkValue()" class="btn_submit">
				</div>
					</div>  </form>
