...
<tr>       
 ...
 <%
		String sql2 = "select prdNo, ctQty from tempcart where ctNo = ?";
...
<%
	...
	String sql5 = "Delete from tempcart where ctNo=?";
...
%>
  ...
  <tr>
	<td colspan = 4 align=center class="order_total"><b>총 적립금</b></td>
