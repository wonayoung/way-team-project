...
<%
	...
	String jsql = "select * from product WHERE chiefNutri = ? OR chiefNutri = ? OR chiefNutri = ? OR chiefNutri = ? OR chiefNutri = ? OR chiefNutri = ? ORDER BY salePrice DESC";
...
<div class="next1">&nbsp; &nbsp;<a style="
    color: #000099; font-weight: bold;" href="viewProductByTarget.jsp?nutri1=<%=nutri1%>&nutri2=<%=nutri2%>&nutri3=<%=nutri3%>&nutri4=<%=nutri4%>&nutri5=<%=nutri5%>&nutri6=<%=nutri6%>">높은 가격</a></div>
