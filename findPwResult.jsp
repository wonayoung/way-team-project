...
<%
		...
		String jsql = "select memPw from member where memId = ? AND memPhone=?";   
...
<%  
		   if(isExist)  {
 %> 
                                       <div class="idchecktext">비밀번호는 <%=rs.getString("memPw")%>입니다.</div>
                                       <br><br>
...
<% }
 ...
 %>
										<div class="idchecktext">정보를 잘못 입력하셨거나 존재하지 않는 ID입니다.</div>
                                       </center><br><br>
